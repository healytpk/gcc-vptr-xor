/* A running demonstration of the -mx32df ABI, using the minimal C library
   built into this ABI's libgcc (libgcc/config/i386/x32df-libc.c).
...
probe (void)
{
  register unsigned long long sp __asm__ ("rsp");
